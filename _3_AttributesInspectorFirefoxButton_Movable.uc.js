(function () {
  ...
  try {
    CustomizableUI.createWidget({
      id: "__unique_identifier_3_attributes_inspector_button", // should match id below
      type: "custom",
   ...
   // defaultArea: CustomizableUI.AREA_NAVBAR,
      onBuild: function (aDocument) {
        ...
        toolbarbutton.onclick = function (aEvent) {
         ...
         // document.getElementById("menu_browserToolbox").click(); // error
            var url = "resource://devtools/client/framework/browser-toolbox/Launcher.jsm";
            var { BrowserToolboxLauncher } = Components.utils.import(url, {});
        ...
        tooltip.push("M: open browser toolbox");
