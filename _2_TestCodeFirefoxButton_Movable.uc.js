(function () {
  ...
  try {
    CustomizableUI.createWidget({
      id: "__unique_identifier_2_test_code_button", // should match id below
      type: "custom",
   ...
   // defaultArea: CustomizableUI.AREA_NAVBAR,
      onBuild: function (aDocument) {
        ...
        function readFromClipboard(aContext) {
         ...
         // trans.addDataFlavor("text/unicode");                   // Firefox 68
            trans.addDataFlavor("text/plain");
            clip.getData(trans, kGlobalClipboard);
         // trans.getTransferData("text/unicode", str, strLength); // Firefox 68
       ...
       // document.getElementById("menu_browserConsole").click(); // error
          var { require } = Components.utils.import("resource://devtools/shared/Loader.jsm", {});
          var { BrowserConsoleManager } = require("devtools/client/webconsole/browser-console-manager");
       ...
       // var ps = Components.classes["@mozilla.org/embedcomp/prompt-service;1"]. // Firefox 109
          var ps = Components.classes["@mozilla.org/prompter;1"].                 // Firefox 110
          ...
          for (var i = 0; i < out.length; i++) {
            ...
            if (choice == 0) {
              BrowserViewSourceOfDocument({URL: out[i].documentURIObject.spec});
              break;
            }
          }
        }
        ...
        var menuitem = aDocument.createXULElement("menuitem");
        menuitem.setAttribute("class", "menuitem-iconic");
        menuitem.setAttribute("label", "Browser Console");
